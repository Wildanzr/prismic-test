...
type MeongDocumentDataSlicesSlice = CallToActionSlice | Hero2Slice;

/**
 * Content for Meong documents
 */
interface MeongDocumentData {
  /**
   * Slice Zone field in *Meong*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: meong.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<MeongDocumentDataSlicesSlice> /**
   * Meta Title field in *Meong*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: meong.meta_title
   * - **Tab**: SEO & Metadata
  ...
  /**
   * Meta Description field in *Meong*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: meong.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Meta Image field in *Meong*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: meong.meta_image
   * - **Tab**: SEO & Metadata
 ...
 */
export type MeongDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<Simplify<MeongDocumentData>, "meong", Lang>;
